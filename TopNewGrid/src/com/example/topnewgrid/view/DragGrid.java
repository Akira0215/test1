...
//			windowParams.y = rawy - itemHeight / 2;
	...
	private void onDrop(int x, int y) {
		...
		//判斷對應position == -1,下移 超過300時算是移動到下方
		if(tempPostion == -1 && y > 600)
		{
			FieldsInfo.moveShowFieldtoHideField(dragPosition);
		}
		else
		{
...
//		}
	...
	public void ViewtoFront(int x,int y,View dragview)
	{	
		...
		windowParams.y = y;
		//設定拖曳ITEM寬高  
		windowParams.width = (int) (1 * dragview.getWidth());
		windowParams.height = (int) (1 * dragview.getHeight());
